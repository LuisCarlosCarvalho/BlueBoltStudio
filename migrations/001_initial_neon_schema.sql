...
-- Compatible with single prepared statements (Vercel Query & Neon SQL Editor)
-- ==============================================================================

DO $$
BEGIN
    -- 1. Enable extension for UUIDs and bcrypt
    CREATE EXTENSION IF NOT EXISTS "pgcrypto";

    -- 2. Table: users (Authentication credentials)
    ...
    -- 3. Table: profiles (User details and platform role)
    ...
    -- 4. Table: projects (Landing pages and marketing assets)
    ...
    -- 5. Table: project_members (Project team collaboration and access levels)
    ...
    RAISE NOTICE 'Esquema de base de dados Blue Bolt Studio configurado com sucesso!';
END $$;
